    ...
    public partial class MainWindow : Form
    {
        ...
        private void buttonAsk_Click(object sender, EventArgs e)
        {
            string info = "Данная программа позволяет строить отрезки и спектры(отрезки, построенные из общей начальной точки с " +
                ...
                "задаются целыми числами. Используется экранная система координат. Сам экран имеет размер 500 на 500 пикселей. Угол измеряется в градусах.";
